...
function validateTailOptions(tailMode, revealOrder) {
  {
    if (tailMode !== undefined && !didWarnAboutTailOptions[tailMode]) {
      if (tailMode !== 'collapsed') {
        ...
        warning$1(false, '"%s" is not a supported value for tail on <SuspenseList />. ' + 'Did you mean "collapsed"?', tailMode);
    ...
    case SuspenseListComponent:
      {
        ...
        if (renderedTail === null) {
          ...
          if (!didSuspendAlready) {
            ...
            var needsRerender = !cannotBeSuspended && hasSuspendedChildrenAndNewContent(workInProgress, renderedChildren);
            if (needsRerender) {
            ...
            didSuspendAlready = (workInProgress.effectTag & DidCapture) !== NoEffect;
          }
          if (didSuspendAlready) {
